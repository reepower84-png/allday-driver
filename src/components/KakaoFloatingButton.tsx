...
export default function KakaoFloatingButton() {
  return (
    <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 flex flex-col items-center gap-3">
      <a
        href="tel:1800-0238"
        className="w-12 h-12 md:w-16 md:h-16 rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110 bg-green-500 hover:bg-green-600 flex items-center justify-center text-white font-bold text-xs md:text-sm"
        aria-label="기사 호출 1800-0238"
      >
        기사호출
      </a>
      <a
